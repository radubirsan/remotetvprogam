...
/// }
/// ```
public enum TVCommandEncoder {
    public static func payload(for command: TVCommand) throws -> Data {
    ...
    public static func rawKeyPayload(keyCode: String, cmd: String = "Click") throws -> Data {
        let payload = Payload(
            method: "ms.remote.control",
            params: .init(
                cmd: cmd,
    ...
    public static func textPayload(for text: String) throws -> Data {
    ...
    public static func voiceKeyPayload(cmd: String) throws -> Data {
    ...
    public static func voiceAudioFrame(pcm: Data) -> Data {
