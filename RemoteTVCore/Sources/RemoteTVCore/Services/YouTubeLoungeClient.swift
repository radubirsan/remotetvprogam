...
public struct YouTubeLoungeClient: Sendable {
    public enum LoungeError: Error, CustomStringConvertible {
    ...
    public func play(screenId: String, videoId: String, listId: String?, startSeconds: Int) async throws {
