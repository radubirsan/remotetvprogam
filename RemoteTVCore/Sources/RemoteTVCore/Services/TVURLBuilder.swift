...
public enum TVURLBuilder {
    public static let appName = "RemoteTV"
    public static let path = "/api/v2/channels/samsung.remote.control"

    public static func connectURL(for device: TVDevice, token: String?) throws -> URL {
